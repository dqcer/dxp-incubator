...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://172.16.2.171:3308/E00001ZS?useUnicode=true&useSSL=false&characterEncoding=utf8");
...
//                        + "/" + tableInfo.getEntityName() + "Entity.hbm" + StringPool.DOT_XML;
//            }
//        });
        ...
        focList.add(new FileOutConfig("/templates/biz.java.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输出文件名 ， 如果你 Entity 设置了前后缀、此处注意 xml 的名称会跟着发生变化！！
                return projectPath + "/src/main/java/" + basePackage.replaceAll("\\.", "\\/") + "/" + pc.getModuleName()
                        + "/" + tableInfo.getEntityName() + "Biz" + StringPool.DOT_JAVA;
            }
        });
